...
const buildPartnerReadyLawyer = (): Lawyer => ({
  ...
  experience: 8,
  price: 70,
  bio: "Δικηγόρος εργατικού δικαίου για ελέγχους συμβάσεων, απολύσεις, αποζημιώσεις και πρακτικά επόμενα βήματα για εργαζόμενους και μικρές επιχειρήσεις στην Ελλάδα.",
  education: "",
  ...
  it("lets partner-editable profile fields make a lawyer search-ready", () => {
    ...
    const partnerLawyer = applyPartnerWorkspaceToLawyer(baseLawyer, {
      ...
      profile: {
        ...
        city: "Αθήνα",
        bio: "Δικηγόρος εργατικού δικαίου για απολύσεις, οφειλόμενους μισθούς, ελέγχους συμβάσεων και πρακτικά επόμενα βήματα για εργαζόμενους και μικρές επιχειρήσεις στην Ελλάδα.",
        experienceYears: 8,
