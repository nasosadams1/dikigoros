...
funnelSteps.push(
  ...
  { name: "case_created", label: "Partner case created" },
  { name: "case_status_updated", label: "Partner case status updated" },
  { name: "case_note_created", label: "Partner case note created" },
);
