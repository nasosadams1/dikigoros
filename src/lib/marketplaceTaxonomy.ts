...
export const legalPracticeAreas: LegalPracticeArea[] = [
  ...
  },
  {
    ...
    description:
      "Κλείστε συμβουλευτική για τροχαία ατυχήματα, ασφαλιστικές απαιτήσεις, αποζημιώσεις και υποθέσεις αυτοκινήτου.",
    keywords: [
      "τροχαία",
      "τροχαια",
      "τροχαίο",
  ...
  },
  {
    ...
    description:
      "Βρείτε δικηγόρους για μισθώσεις, ενοίκια, αποδόσεις μισθίου, έξωση και διαφορές ιδιοκτήτη-μισθωτή.",
    keywords: [
      "μίσθωση",
      "μισθωση",
      "μισθώσεις",
