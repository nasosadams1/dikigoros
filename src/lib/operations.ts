  ...
  return [
    {
      ...
      evidence: `${paymentEvidenceChecks.filter((check) => check.ready).length}/${paymentEvidenceChecks.length} σενάρια πληρωμής έχουν κλείσει με live ή δοκιμαστικά στοιχεία.`,
    },
    {
      label: "Το webhook και η συμφωνία πληρωμών λειτουργούν",
      owner: "Υπεύθυνος πληρωμών",
      ...
      evidence: "Απαιτεί live λειτουργία Stripe και κλειστή υπόθεση που αποδεικνύει συμφωνία webhook για πληρωμή, αποτυχία, επιστροφή και ορατή απόδειξη.",
    },
    {
      label: "Οι καταστάσεις λογαριασμού συμφωνούν με το backend",
      owner: "Υπεύθυνος υποστήριξης",
      ...
      evidence: "Απαιτεί backend πηγή λειτουργίας και κλειστή υπόθεση που αποδεικνύει ότι οι καταστάσεις λογαριασμού συμφωνούν με το backend.",
    },
    {
      label: "Οι ροές υποστήριξης έχουν υπεύθυνο και χρόνο απόκρισης",
      owner: "Υπεύθυνος λειτουργίας",
      ...
      evidence: `${supportEvidenceChecks.filter((check) => check.ready).length}/${supportEvidenceChecks.length} ροές υποστήριξης έχουν κλειστή δοκιμαστική ή live απόδειξη.`,
    },
    {
      label: "Η δημοσίευση κριτικών ακολουθεί υποχρεωτική ροή ελέγχου",
      owner: "Έλεγχος εμπιστοσύνης",
    ...
    },
    {
      ...
      evidence: "Απαιτεί κλειστή υπόθεση απόδειξης απόδοσης συνεργάτη, βασισμένη σε πραγματικό dashboard με live δεδομένα.",
    },
    {
