...
export const operatingRules: OperatingRule[] = [
  {
    ...
    evidenceNeeded: ["κωδικός κράτησης", "κωδικός πληρωμής ή Checkout session", "email πελάτη", "ορατή κατάσταση πληρωμής στον λογαριασμό"],
    actions: [
      "Επιβεβαίωση ότι υπάρχει εγγραφή πληρωμής για την κράτηση και ότι συμφωνεί με το ποσό.",
      "Έλεγχος Stripe Checkout session, payment intent, webhook event και URL απόδειξης.",
      ...
      "Στην παραγωγή απαιτούνται live Stripe keys και live webhook secret πριν λειτουργήσει το Checkout.",
    ],
    userOutcome: "Ο χρήστης βλέπει πληρωμένη, αποτυχημένη, επιστραφείσα ή υπό έλεγχο πληρωμή με μία σαφή επόμενη ενέργεια.",
    escalation: "Άμεση κλιμάκωση για διπλή χρέωση, απόδειξη που λείπει μετά από επιτυχία ή ασυμφωνία webhook.",
    closeCondition: "Stripe session, εγγραφή πληρωμής, κατάσταση κράτησης, μήνυμα χρήστη και απόδειξη/επιστροφή συμφωνούν.",
  ...
  },
  {
    ...
    actions: [
      ...
      "Έγκριση μόνο όταν οι τρόποι συμβουλευτικής, τιμές, γλώσσες και διαθεσιμότητα είναι usable.",
    ...
    escalation: "Κλιμάκωση κάθε παλιάς ή αμφισβητούμενης επαλήθευσης πριν μείνουν live αλλαγές προφίλ.",
  ...
  },
  {
    ...
    actions: [
      ...
      "Καταγραφή αιτημάτων πρόσβασης και διαγραφής μαζί με το σχετικό context κράτησης/λογαριασμού.",
    ...
    closeCondition: "Η ορατότητα, το αίτημα διαγραφής, ο λόγος διατήρησης και το audit event έχουν καταγραφεί και εξηγηθεί στον χρήστη.",
  ...
  },
  {
    ...
    actions: [
      "Περιορισμός πρόσβασης και διατήρηση σχετικού audit context.",
...
export const supportWorkflows: SupportWorkflow[] = [
  ...
  },
  {
    ...
    requiredEvidence: ["κωδικός κράτησης", "Stripe Checkout session", "εγγραφή πληρωμής", "email χρήστη"],
    escalationRule: "Άμεση κλιμάκωση για πιθανή διπλή χρέωση, ασυμφωνία webhook ή απόδειξη που λείπει.",
  ...
  },
  {
    ...
    closeCondition: "Η ορατότητα, το αίτημα διαγραφής, ο λόγος διατήρησης και το audit event έχουν καταγραφεί.",
  },
  {
    id: "privacy_request",
...
export const launchGates: LaunchGate[] = [
  {
    ...
    owner: "Υπεύθυνος πληρωμών",
    ready: false,
    evidence: "Σύγκρουση ώρας, αποτυχία/άνοιγμα/επιτυχία Checkout, ακύρωση, επιστροφή και απόδειξη έχουν κλεισμένα αποδεικτικά end-to-end.",
  },
  {
    label: "Το webhook και η συμφωνία πληρωμών λειτουργούν",
    owner: "Υπεύθυνος πληρωμών",
    ready: true,
    evidence: "Το Stripe webhook γράφει πληρωμένη, αποτυχημένη ή επιστραφείσα κατάσταση, provider event, απόδειξη και κατάσταση πληρωμής κράτησης.",
  },
  {
  ...
  },
  {
    ...
    ready: true,
    evidence: "Τα funnel events γράφονται στο Supabase funnel_events με session, user, lawyer, booking, city, category και source.",
  },
  {
    label: "Η βασική πυκνότητα πόλης/δικαίου έχει επιτευχθεί",
    owner: "Υπεύθυνος προσφοράς αγοράς",
    ready: false,
    evidence: "Οι 5 επιτρεπόμενες πόλεις και τα 5 επιτρεπόμενα δίκαια πληρούν verified, price, availability, review και bookable thresholds.",
  },
  {
...
export const bookingPaymentEvidenceScenarios = [
  {
    label: "επιτυχής live κράτηση",
    terms: ["successful live booking", "payment succeeded", "receipt visible", "confirmed_paid", "επιτυχής live κράτηση", "επιτυχής πληρωμή", "ορατή απόδειξη", "πληρωμένη κράτηση"],
  },
  {
  ...
  return [
    {
      ...
      evidence: `${paymentEvidenceChecks.filter((check) => check.ready).length}/${paymentEvidenceChecks.length} σενάρια πληρωμής έχουν κλείσει με live/staged στοιχεία.`,
    },
    {
      label: "Το webhook και η συμφωνία πληρωμών λειτουργούν",
      owner: "Υπεύθυνος πληρωμών",
      ...
      evidence: "Απαιτεί live Stripe mode και κλειστή υπόθεση που αποδεικνύει paid/failed/refunded webhook reconciliation και ορατή απόδειξη.",
    },
    {
      label: "Οι καταστάσεις λογαριασμού συμφωνούν με το backend",
      owner: "Υπεύθυνος υποστήριξης",
      ...
      evidence: "Απαιτεί backend ops source και κλειστή υπόθεση που αποδεικνύει ότι οι καταστάσεις λογαριασμού συμφωνούν με το backend.",
    },
    {
      label: "Οι ροές υποστήριξης έχουν υπεύθυνο και χρόνο απόκρισης",
      owner: "Υπεύθυνος λειτουργίας",
      ...
      evidence: `${supportEvidenceChecks.filter((check) => check.ready).length}/${supportEvidenceChecks.length} ροές υποστήριξης έχουν κλειστή staged ή live απόδειξη.`,
    },
    {
      label: "Η δημοσίευση κριτικών ακολουθεί υποχρεωτική ροή ελέγχου",
      owner: "Έλεγχος εμπιστοσύνης",
    ...
    },
    {
      ...
      evidence: `${funnelCoverage.checks.filter((check) => check.ready).length}/${funnelCoverage.checks.length} απαιτούμενα events καταγράφηκαν σε παράθυρο ${funnelCoverage.observedDays.toFixed(1)} ημερών.`,
    },
    {
      label: "Η βασική πυκνότητα πόλης/δικαίου έχει επιτευχθεί",
      owner: "Υπεύθυνος προσφοράς αγοράς",
      ready: coreDensityReady,
      evidence: "Οι 5 επιτρεπόμενες πόλεις πρέπει να καλύπτουν τα verified thresholds και κάθε επιτρεπόμενο δίκαιο να έχει αρκετή κρατήσιμη προσφορά.",
    },
    {
      label: "Το dashboard δικηγόρου δείχνει καθαρά την απόδοση",
      owner: "Επιτυχία συνεργατών",
      ...
      evidence: "Απαιτεί κλειστή υπόθεση απόδειξης ROI συνεργάτη, βασισμένη σε πραγματικό dashboard με live δεδομένα.",
    },
    {
      label: "Οι λειτουργίες είναι backend-first",
      owner: "Υπεύθυνος λειτουργίας",
      ready: operationalCasesSource === "backend",
      evidence: operationalCasesSource === "backend" ? "Οι υποθέσεις και τα metrics λειτουργίας διαβάζονται από Supabase." : "Οι υποθέσεις λειτουργίας χρησιμοποιούν ακόμα τοπικό fallback cache.",
    },
  ];
};
  ...
  return [
    {
      ...
      detail: "Απαιτείται για επαληθευμένες κρατήσεις, εγγραφές πληρωμών, αποδείξεις λογαριασμού και webhook settlement.",
    },
    {
      label: "Τοπικό fallback κρατήσεων απενεργοποιημένο για launch",
      ready: !localBookingFallback,
      detail: "Το launch δεν πρέπει να δέχεται πληρωμένες κρατήσεις που υπάρχουν μόνο στο browser storage.",
    },
    {
      label: "Απαίτηση live πληρωμών",
      ready: requireLivePayments,
      detail: "Ορίστε VITE_REQUIRE_LIVE_PAYMENTS=true στην εφαρμογή και REQUIRE_LIVE_STRIPE=true στις payment functions.",
    },
    {
      label: "Μοντέλο Stripe Checkout",
      ready: true,
      detail: "Η πληρωμή κράτησης χρησιμοποιεί Stripe-hosted Checkout Sessions, με metadata κράτησης σε Checkout Session και PaymentIntent.",
    },
    {
      label: "Διαδρομή webhook settlement",
      ready: true,
      detail: "Το Stripe webhook ενημερώνει πληρωμένη, αποτυχημένη και επιστραφείσα κατάσταση και κρατά provider event context.",
    },
  ];
};
