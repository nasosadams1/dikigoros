...
const trustPages = {
  ...
  "/trust/payments-refunds": {
    ...
    rules: [
      ...
      ["Στοιχεία", "Κράτηση, Stripe Checkout session, payment intent, webhook, απόδειξη και χρόνος ακύρωσης."],
  ...
  "/trust/privacy-documents": {
    ...
    rules: [
      ...
      ["Στοιχεία", "Έγγραφο, λογαριασμός, συνδεδεμένη κράτηση, ιστορικό ορατότητας, audit και αίτημα χρήστη."],
      ["Συνέπεια", "Το αρχείο μπορεί να γίνει ιδιωτικό, να ζητηθεί διαγραφή, να διαγραφεί ή να κρατηθεί με αιτιολογία."],
      ["Χρόνος και υποστήριξη", "Αιτήματα πρόσβασης/διαγραφής έως 2 εργάσιμες. Πιθανή έκθεση την ίδια εργάσιμη με privacy/security."],
    ],
  },
  "/trust/support-complaints": {
    ...
    rules: [
      ...
      ["Στοιχεία", "Email, κωδικός κράτησης/πληρωμής, περιγραφή, προτεραιότητα και σχετικά αποδεικτικά."],
  ...
  "/trust/security": {
    ...
    rules: [
      ...
      ["Στοιχεία", "Λογαριασμός, επηρεαζόμενη κράτηση/έγγραφο, χρόνος συμβάντος, πιθανό εύρος και διαθέσιμο audit."],
