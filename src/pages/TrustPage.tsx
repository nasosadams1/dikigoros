...
const trustPages = {
  "/trust/verification-standards": {
    ...
    rules: [
      ["Πότε εφαρμόζεται", "Σε νέα αίτηση, αλλαγή δημόσιου προφίλ, καταγγελία ακρίβειας ή σήμα επαναλαμβανόμενης ακύρωσης."],
      ["Στοιχεία", "Ταυτότητα, μητρώο, δικηγορικός σύλλογος, τρόποι συνεδρίας, τιμές, διαθεσιμότητα και στοιχεία επικοινωνίας."],
      ["Συνέπεια", "Προφίλ μπορεί να μείνει μη δημόσιο, να ζητηθούν αλλαγές, να ανασταλεί ή να αφαιρεθεί."],
      ["Χρόνος και υποστήριξη", "Συνήθης έλεγχος 2-3 εργάσιμες. Διαφωνίες ανοίγουν υπόθεση υποστήριξης/επαλήθευσης."],
    ],
  },
  "/trust/reviews-policy": {
    ...
    rules: [
      ["Πότε εφαρμόζεται", "Μετά από συμβουλευτική που ο δικηγόρος έχει επιβεβαιώσει ως ολοκληρωμένη."],
      ["Στοιχεία", "Κράτηση, κατάσταση ολοκλήρωσης, κείμενο, βαθμολογίες και τυχόν ένσταση."],
      ["Συνέπεια", "Η κριτική μπορεί να μείνει σε έλεγχο, να δημοσιευτεί, να απορριφθεί ή να ανοίξει δικαίωμα απάντησης."],
      ["Χρόνος και υποστήριξη", "Κανονικός έλεγχος 48 ώρες. Κατάχρηση, απάτη ή ιδιωτικά στοιχεία ελέγχονται την ίδια εργάσιμη."],
    ],
  },
  "/trust/payments-refunds": {
    ...
    rules: [
      ["Πότε εφαρμόζεται", "Σε άνοιγμα Checkout, επιτυχή πληρωμή, αποτυχία, διακοπή, ακύρωση ή αίτημα επιστροφής."],
      ["Στοιχεία", "Κράτηση, συνεδρία πληρωμής Stripe, εντολή πληρωμής, συμβάν επιβεβαίωσης, απόδειξη και χρόνος ακύρωσης."],
      ["Συνέπεια", "Η κατάσταση μπορεί να είναι δεν άνοιξε, άνοιξε, πληρώθηκε, απέτυχε, ζητήθηκε επιστροφή ή επιστράφηκε."],
      ["Χρόνος και υποστήριξη", "Αποτυχίες και διπλές χρεώσεις ελέγχονται την ίδια εργάσιμη. Επιστροφές με ασαφή στοιχεία έως 2 εργάσιμες."],
    ],
  },
  "/trust/privacy-documents": {
    ...
    rules: [
      ["Πότε εφαρμόζεται", "Σε ανέβασμα, αλλαγή ορατότητας, λήψη, αίτημα διαγραφής, αίτημα πρόσβασης ή πιθανή έκθεση."],
      ["Στοιχεία", "Έγγραφο, λογαριασμός, συνδεδεμένη κράτηση, ιστορικό ορατότητας, ιστορικό ελέγχου και αίτημα χρήστη."],
      ["Συνέπεια", "Το αρχείο μπορεί να γίνει ιδιωτικό, να ζητηθεί διαγραφή, να διαγραφεί ή να κρατηθεί με αιτιολογία."],
      ["Χρόνος και υποστήριξη", "Αιτήματα πρόσβασης/διαγραφής έως 2 εργάσιμες. Πιθανή έκθεση ελέγχεται την ίδια εργάσιμη από την ομάδα απορρήτου και ασφάλειας."],
    ],
  },
  "/trust/support-complaints": {
    ...
    rules: [
      ["Πότε εφαρμόζεται", "Σε αποτυχία κράτησης, ακύρωση δικηγόρου, πληρωμή, πρόσβαση λογαριασμού, έγγραφο, παράπονο ή ένσταση κριτικής."],
      ["Στοιχεία", "Ηλεκτρονικό ταχυδρομείο, κωδικός κράτησης/πληρωμής, περιγραφή, προτεραιότητα και σχετικά αποδεικτικά."],
      ["Συνέπεια", "Η υπόθεση μπορεί να λυθεί, να ζητήσει στοιχεία, να κλιμακωθεί, να απορριφθεί με λόγο ή να οδηγήσει σε ενέργεια προφίλ."],
      ["Χρόνος και υποστήριξη", "Επείγοντα κράτησης/πληρωμής την ίδια εργάσιμη. Κανονικά αιτήματα έως 2 εργάσιμες."],
    ],
  },
  "/trust/security": {
    icon: LockKeyhole,
    ...
    rules: [
      ["Πότε εφαρμόζεται", "Σε ύποπτη πρόσβαση, ασυμφωνία πληρωμής, πιθανή έκθεση εγγράφου ή αναφορά περιστατικού."],
      ["Στοιχεία", "Λογαριασμός, επηρεαζόμενη κράτηση/έγγραφο, χρόνος συμβάντος, πιθανό εύρος και διαθέσιμο ιστορικό ελέγχου."],
      ["Συνέπεια", "Περιορισμός πρόσβασης, έλεγχος έκτασης, ενημέρωση χρηστών όπου απαιτείται και διορθωτική ενέργεια."],
      ["Χρόνος και υποστήριξη", "Άμεσο triage από security/privacy πριν μείνει σε κανονική ουρά υποστήριξης."],
    ],
  },
} as const;
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-5xl px-5 py-12 lg:px-8 lg:py-16">
        ...
        <section className="mt-8 rounded-lg border border-border bg-card p-5">
          <h2 className="text-lg font-bold text-foreground">Συγκεκριμένοι κανόνες εφαρμογής</h2>
