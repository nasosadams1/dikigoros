...
const firmTools = [
  { icon: UsersRound, title: "Δημόσια καταχώριση", text: "Ειδικεύσεις, γλώσσες, τιμές και στοιχεία αξιοπιστίας σε καθαρή μορφή." },
  ...
  { icon: ShieldCheck, title: "Έλεγχος ένταξης", text: "Έλεγχος στοιχείων πριν από τη δημόσια εμφάνιση στην αναζήτηση." },
  { icon: TrendingUp, title: "Πίνακας συνεργάτη", text: "Διαθεσιμότητα, κρατήσεις, πληρωμές και αναφορές απόδοσης αναζήτησης." },
];
...
const plans = [
  {
    ...
    includes: ["Ελεγμένη δημόσια καταχώριση", "Κρατήσεις και πληρωμές πρώτης συμβουλευτικής", "Αξιολογήσεις μετά από ολοκληρωμένο ραντεβού"],
  },
  {
    name: "Επαγγελματικό",
    ...
    includes: ["Όλα του Βασικού", "Σήμανση ενισχυμένης προβολής", "Στατιστικά αναζήτησης και κρατήσεων"],
  },
  {
    name: "Πλήρες",
      ...
      <div className="space-y-5">
          ...
          <div className="grid gap-6 lg:grid-cols-[1.1fr_0.9fr] lg:items-start">
            <div className="max-w-[780px]">
              ...
              <p className="mt-4 max-w-[64ch] text-[15px] leading-6 text-muted-foreground">
                Το Dikigoros βοηθά τους πελάτες να επιλέγουν με μεγαλύτερη σιγουριά, μέσα από σαφείς καταχωρίσεις, πραγματική διαθεσιμότητα και αξιολογήσεις μετά από ολοκληρωμένα ραντεβού.
              </p>
        ...
        <section className="partner-panel p-7 lg:p-8">
          <div className="max-w-[760px]">
            ...
            <h2 className="mt-3 font-sans text-[30px] font-semibold leading-tight tracking-[-0.02em] text-[hsl(var(--partner-ink))]">
              Όχι απλή παρουσία σε κατάλογο. Πιο καθαρή προετοιμασία, κράτηση και αξιολόγηση.
            </h2>
          </div>
