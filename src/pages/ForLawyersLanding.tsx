...
const pricingRules = [
  "Στο Βασικό δεν υπάρχει πάγιο. Η χρέωση €7 εφαρμόζεται μόνο όταν η πρώτη συμβουλευτική ολοκληρωθεί.",
  "Ακύρωση, αποτυχία πληρωμής ή μη πραγματοποίηση ραντεβού δεν θεωρούνται ολοκληρωμένο πρώτο ραντεβού.",
  "Τα πλάνα Επαγγελματικό και Πλήρες προσθέτουν ετήσια επιλογή, καθαρά σημειωμένη προβολή, στατιστικά και εργαλεία διαχείρισης για γραφεία με περισσότερη ζήτηση.",
];
...
const plans = [
  {
    ...
    includes: ["Ελεγμένο δημόσιο προφίλ", "Κρατήσεις συμβουλευτικής", "Πληρωμές πρώτης συμβουλευτικής", "Αξιολογήσεις μετά από ολοκληρωμένο ραντεβού"],
  },
  {
    name: "Επαγγελματικό",
    ...
    includes: ["Όλα του Βασικού", "Σήμανση ενισχυμένης προβολής", "Στατιστικά προφίλ και κρατήσεων", "Πιο πλήρη εργαλεία δημόσιου προφίλ"],
  },
  {
    name: "Πλήρες",
    ...
    includes: ["Όλα του Επαγγελματικού", "Ροή υποθέσεων συνεργάτη", "Ιδιωτικές σημειώσεις και υπενθυμίσεις", "Αιτήματα εγγράφων και αναλυτικά ανά πόλη/κατηγορία"],
  },
  {
    name: "Γραφεία / Ομάδες",
    commercial: "Από €127.99 / μήνα",
    bestFor: "Για ομάδες έως 3 δικηγόρων, με επιπλέον θέσεις +€25 / μήνα ανά δικηγόρο.",
    includes: ["Έως 3 δικηγόροι", "Ροή υποθέσεων και αναλυτικά", "Προσαρμοσμένη εγκατάσταση", "Επικοινωνία για πολλές πόλεις"],
  },
];

const addOns = ["Ελεγμένη καταχώριση", "Ενισχυμένη προβολή με σήμανση", "Στατιστικά απόδοσης", "Ροή υποθέσεων και υπενθυμίσεις"];
