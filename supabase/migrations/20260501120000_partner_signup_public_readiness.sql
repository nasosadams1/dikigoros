...
drop function if exists public.submit_partner_application(uuid,text,text,text,text,text,text,text,text,text,text,text[],text,jsonb,text);
drop function if exists public.submit_partner_application(uuid,text,text,text,text,text,text,text,text,text,text,text[],text,jsonb,jsonb,jsonb,text);
drop function if exists public.submit_partner_application(uuid,text,text,text,text,text,text,text,text,text,text,text[],text,jsonb,jsonb,jsonb,jsonb,text);
